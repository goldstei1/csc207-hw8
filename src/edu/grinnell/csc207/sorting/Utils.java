...
class Utils {
	...
	int secondPlace = lb2;
	// Invariants:
	//   I1(i) = Utils.sorted(merged,0,i).
	//   I2(i) = Utils.sorted(a1, 0, a1.length)
	//   I3(i) = Utils.sorted(a2, 0, a2.length)
	while (firstPlace < ub1 && secondPlace < ub2) {
	    // compare an element from each array, and put whichever comes first
